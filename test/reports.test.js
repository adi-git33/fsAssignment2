...
describe('GET /reports/:reportId', () => {
  ...
  it('should return report with specific id', async () => {
    ...
    reportsRepository.prototype.retrieveReport.mockResolvedValue(mockReports[0]);
  ...
  it('should return 404 if id wasnt found', async () => {
    ...
    reportsRepository.prototype.retrieveReport.mockResolvedValue(mockReports[14]);
  ...
  it('should return 400 if id isnt by the format', async () => {
    const mockReports = [];
    reportsRepository.prototype.retrieveReport.mockResolvedValue(mockReports);
  ...
  // Failure 500
  it('should return 500 when an error occurs', async () => {
    reportsRepository.prototype.retrieveReport.mockRejectedValue(new ServerError('internal server error'));
...
describe('POST /reports', () => {
  ...
  it('should return 200', async () => {
    ...
    reportsRepository.prototype.createReport.mockResolvedValue(mockReports);
...
describe('DELETE /reports/:reportId', () => {
  ...
  it('should return deleted report with specific id', async () => {
    ...
    reportsRepository.prototype.deleteReport.mockResolvedValue(mockReports);
  ...
  // Failure 404
  it('should return 404 if id wasnt found', async () => {
    reportsRepository.prototype.deleteReport.mockResolvedValue(null);
  ...
  // Failure 500
  it('should return 500 when an error occurs', async () => {
    reportsRepository.prototype.deleteReport.mockRejectedValue(new ServerError('internal server error'));
